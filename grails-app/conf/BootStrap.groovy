...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def nasdaq = new Exchange(name:"NASDAQ", country:"US").save(flush:true)
		def dj = new Exchange(name:"Dow Jones", country:"US").save(flush:true)
		def paris = new Exchange(name:"Bourse de Paris", country:"FR").save(flush:true)
		def lse = new Exchange(name:"London Stock Exchange", country:"UK").save(flush:true)
		def sp = new Exchange(name:"S&P", country:"US").save(flush:true)
